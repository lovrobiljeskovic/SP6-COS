class Cars {
    ...
    getCar(id) {
          return this._data.find(function(car) {
                return car.id === id
          })
    ...
    deleteCar(id) {
    /*
        for (var i = id; i < this._data.length; i++) {
            var result = this._data.splice(i, 1);                                
                    break;
                }
                return result;
            }
            */
        this._data.splice(this._data.findIndex(function(car) {
            return car.id === id
        }),1)
    ...
    console.log(cars.getCar(10));   
    cars.addCar("Ferrari");
    console.log(cars.deleteCar(10));
